...
def full_scan(part):
    ...
    while i >= tmp:
        ...
        files_len -= 1
        i -= 1
    runtime = int(time.time() - os.startfile())
...
def gui_thread():
    ...
    #Buttons
    update_button = tkinter.Button(main, bg=bgc
    , fg=fgc, text = "Update", command=lambda:button_action_handler("update_button"), height = hoehe, width = breite)
